...
class AutomatedBotTester {
        ...
        try {
            ...
            for (let i = 0; i < scenario.steps.length; i++) {
                ...
                try {
                    ...
                    await webhook_1.webhookController.handleWebhook(mockReq, mockRes);
    ...
    async testUserService() {
        try {
            ...
            const testUser = await userService_1.userService.createUser({
            ...
            const retrievedUser = await userService_1.userService.getUserByWhatsAppId('919999999901');
            if (retrievedUser) {
